	...
	<body>
		...
		<div>
			...
			<table border="0px" width="100%" height="150px">
				...
				<td><?php if (isset($_SESSION['user_name'])) echo $_SESSION['user_name']?>
						<a href="login.php">
		...
		<form method="post" action="resetVal.php">
			<table style="margin: auto">
				<tr>
		<td> <h3>Current Password</h3></td>  <td><input type="text" name="password1" required></td>
		</tr>
		...
		<?php 
		if ( isset($_SESSION['reset_flag']) && $_SESSION['reset_flag']==1){
			echo $_SESSION['reset_flag'];
		?> 
		<font color="red">Your Current password is wrong</font>
		
		<?php } else if (isset($_SESSION['reset_flag']) && $_SESSION['reset_flag']==2) {?>
			<font color="green">Succesfully updated</font>
			
			<?php } else if (isset($_SESSION['reset_flag']) && $_SESSION['reset_flag']==3) {?>
			<font color="red">not updated</font>
			
			<?php } else if (isset($_SESSION['reset_flag']) && $_SESSION['reset_flag']==4) {?>
